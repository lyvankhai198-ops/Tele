...
import AdminPurchaseOrdersPage from '@/pages/admin-purchase-orders';
  ...
  return (
    <RoutedErrorBoundary>
      <Switch>
        ...
        <Route path="/admin/purchase-orders" component={() => <AdminRoute><AdminPurchaseOrdersPage /></AdminRoute>} />
