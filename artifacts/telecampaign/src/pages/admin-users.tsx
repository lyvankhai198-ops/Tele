...
const copy = {
  en: {
    ...
    warningDetail: "Admins can upgrade, downgrade, or extend a plan. An active plan keeps its remaining time and the new duration is added. Please ensure the change is authorized.",
  ...
  vi: {
    ...
    warningDetail: "Admin có thể nâng cấp, hạ cấp hoặc gia hạn gói. Gói đang hiệu lực sẽ giữ thời gian còn lại và cộng thêm thời hạn mới. Vui lòng đảm bảo thay đổi đã được cấp quyền.",
