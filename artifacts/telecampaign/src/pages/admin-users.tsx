...
const copy = {
  en: {
    ...
    warningDetail: "Admins can upgrade, downgrade, or extend a plan. For an unclaimed PLUS trial, the entered duration resets the trial from now. Activated subscriptions keep their remaining time and add the new duration.",
  ...
  vi: {
    ...
    warningDetail: "Admin có thể nâng cấp, hạ cấp hoặc gia hạn gói. Trial PLUS chưa kích hoạt key sẽ được đặt lại đúng số ngày nhập từ hiện tại. Gói đã kích hoạt giữ thời gian còn lại và cộng thêm thời hạn mới.",
