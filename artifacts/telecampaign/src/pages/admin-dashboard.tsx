...
const copy = {
  ...
  vi: {
    ...
    purchases: "Thanh toán & đơn mua gói",
    purchasesDetail: "Đặt giá VND/USDT trên thẻ gói, nhập thông tin nhận tiền và duyệt đơn mua trên web.",
    revenue: "Doanh thu & khách hàng",
    revenueDetail: "Theo dõi doanh thu license key, tồn kho và xếp hạng khách hàng ruột.",
...
export default function AdminDashboardPage() {
  ...
  const cards = [
    ...
    { path: "/admin/purchase-orders", title: text.purchases, detail: text.purchasesDetail, icon: CircleDollarSign, tone: "blue" },
    { path: "/admin/revenue", title: text.revenue, detail: text.revenueDetail, icon: CircleDollarSign, tone: "green" },
