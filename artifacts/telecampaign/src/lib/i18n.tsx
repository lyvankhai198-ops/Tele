...
const translations: Record<string, string> = {
  ...
  "System": "Hệ thống",
  "Failed": "Thất bại",
  "Operator workspace": "Không gian vận hành",
  "Make the next send": "Tạo lần gửi tiếp theo",
  "worth opening.": "đáng để mở.",
  "A clear view of what is ready, what needs your eye, and what will move when you press send.": "Góc nhìn rõ ràng về những gì đã sẵn sàng, cần bạn xem lại và sẽ chạy khi bạn bắt đầu gửi.",
  "Build a campaign": "Tạo chiến dịch",
  "Delivery pulse": "Nhịp độ gửi",
  "Within safe sending limits": "Trong giới hạn gửi an toàn",
  "Next on the desk": "Việc tiếp theo",
  "Review before sending": "Kiểm tra trước khi gửi",
  "No scheduled campaign": "Chưa có chiến dịch được lên lịch",
  "The working queue": "Hàng đợi đang xử lý",
  "Campaigns in motion": "Chiến dịch đang triển khai",
  "View all": "Xem tất cả",
  "Quiet confidence": "Tín hiệu yên tâm",
  "Signal check": "Kiểm tra tín hiệu",
  "managed": "đang quản lý",
  "approved": "đã duyệt",
  "in workspace": "trong không gian",
