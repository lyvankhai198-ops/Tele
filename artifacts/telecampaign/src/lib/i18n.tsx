...
const translations: Record<string, string> = {
  ...
  "Buy key": "Mua key",
  "Pay with Bank Transfer (VND)": "Thanh toán chuyển khoản (VND)",
  "Pay with USDT": "Thanh toán USDT",
  "Pending": "Đang chờ",
  "Approved": "Đã duyệt",
  "Rejected": "Từ chối",
  ...
  "Could not create order": "Không thể tạo đơn hàng",
  "Transfer Info": "Thông tin chuyển khoản",
  "Bank": "Ngân hàng",
  "Bank Account": "Số tài khoản",
  "Account Name": "Tên tài khoản",
  "Amount": "Số tiền",
  "Transfer Reference": "Nội dung CK",
  "Submit proof": "Gửi xác nhận",
  "Proof submitted successfully": "Gửi xác nhận thành công",
  "Could not submit proof": "Không thể gửi xác nhận",
  "Order History": "Lịch sử mua hàng",
  "Network": "Mạng",
  "Address": "Địa chỉ",
  "Transaction Hash": "Mã giao dịch (TxHash)",
  "Message/Proof (Optional)": "Tin nhắn/Bằng chứng (Tùy chọn)",
  "Copied!": "Đã sao chép!",
  "Price": "Giá",
  "Order checkout": "Thanh toán",
  "Order Close": "Đóng",
  "Please transfer the exact amount with the reference code below.": "Vui lòng chuyển khoản đúng số tiền với nội dung CK bên dưới.",
  "Please transfer exactly to the address below.": "Vui lòng chuyển đúng số USDT vào địa chỉ bên dưới.",
  "Please enter your transaction hash after transferring.": "Vui lòng nhập mã giao dịch (TxHash) sau khi chuyển.",
  "Please enter payment proof info.": "Vui lòng nhập thông tin xác nhận thanh toán.",
  "Order Settings": "Cài đặt đơn hàng",
  "Orders": "Đơn hàng",
  "Duration": "Thời hạn",
  "Price unavailable": "Chưa có giá",
  "Resume": "Tiếp tục thanh toán",
  "Plan Pricing & Durations": "Giá & Thời hạn các gói",
  "Payment Details": "Thông tin thanh toán",
  "Bank Code/Name": "Mã / Tên ngân hàng",
  "Bank Account Number": "Số tài khoản ngân hàng",
  "VietQR Template": "Mẫu VietQR",
  "Optional": "Tùy chọn",
  "USDT BEP20 Address": "Địa chỉ USDT BEP20",
  "USDT TRC20 Address": "Địa chỉ USDT TRC20",
  "Save Settings": "Lưu cài đặt",
  "Verify money received before approving orders.": "Xác nhận đã nhận tiền trước khi duyệt đơn.",
  "Proof": "Xác nhận",
  "Actions": "Hành động",
  "No orders found": "Không có đơn hàng nào",
  "Verify Money Received!": "Xác nhận đã nhận tiền!",
  "Reject Order": "Từ chối đơn",
  "Do not approve this order unless you have successfully verified the funds in your bank or crypto wallet. Once approved, the user's limits will be instantly expanded.": "Không duyệt đơn này trừ khi bạn đã xác minh tiền trong ngân hàng hoặc ví crypto. Sau khi duyệt, giới hạn của người dùng sẽ được mở ngay lập tức.",
  "Are you sure you want to reject this order? The user will have to create a new one to try again.": "Bạn có chắc muốn từ chối đơn này? Người dùng sẽ phải tạo đơn mới để thử lại.",
  "Approve Order": "Duyệt đơn",
  "Actually, reject this order": "Thực ra, tôi muốn từ chối đơn này",
  "Confirm Approval": "Xác nhận duyệt",
